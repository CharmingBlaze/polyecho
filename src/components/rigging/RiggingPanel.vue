  ...
  <div class="h-full w-full bg-ui-panel flex flex-col select-none overflow-y-auto p-3 text-ui-textPrimary space-y-3 font-mono text-xs">
    ...
    <div class="flex items-center justify-between pb-2 border-b border-ui-borderSubtle">
      <div class="flex items-center space-x-2">
        ...
        <div>
          ...
          <p class="text-[10px] text-ui-textMuted">Custom skeletal bones & rigid limb parenting</p>
        </div>
      </div>
    ...
    <div class="bg-ui-surface p-2.5 rounded-xs border border-ui-borderSubtle space-y-2">
      ...
      <div class="grid grid-cols-2 gap-1.5">
        <button 
          @click="handleAddRoot"
          class="py-1.5 px-2 rounded-xs bg-ui-accent hover:bg-ui-accentHover text-white font-bold text-[10px] flex items-center justify-center space-x-1 shadow transition"
        ...
        <button 
          @click="handleExtrude"
          class="py-1.5 px-2 rounded-xs bg-ui-input hover:bg-ui-hover border border-ui-borderSubtle text-ui-textAccent text-[10px] flex items-center justify-center space-x-1 transition"
        ...
        <button 
          ...
          class="py-1.5 px-2 rounded-xs bg-ui-input hover:bg-ui-hover border border-ui-borderSubtle text-ui-textPrimary text-[10px] flex items-center justify-center space-x-1 disabled:opacity-40 transition"
